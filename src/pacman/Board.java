...
//            }
    ...
    private void loadImages() {
        ...
        pacman4up = new ImageIcon("images/PacMan2up.gif").getImage();
        ...
        pacman4left = new ImageIcon("images/PacMan2left.gif").getImage();
        pacman2right = new ImageIcon("images/PacMan3right.gif").getImage();
